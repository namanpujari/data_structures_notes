// Provided by:   ____________Naman Pujari__________
// Email Address: ____________npujari000@citymail.cuny.edu________
// FILE: sequence2.h
...
//     Precondition: The parameter source is a valid sequence object with
//     all associated member variables having valid values. 
//     Postcondition: New sequence is constructed, and is a copy of the source 
//     sequence, or the parameter.
//
...
namespace main_savitch_4
{
    ...
    public:
        ...
        sequence(const sequence& source); // This is the destructor
        ~sequence( );
        ...
        size_type size( ) const { return total_used; }
        bool is_item( ) const;
        value_type current( ) const;
    private:
		value_type *data_pointer; // The pointer to an array of value_type values
		size_type total_used; // Number of values in sequence/number of slots used in dynamic array
		size_type current_item_index; // Marker used to determine functionality of
		// advance/insert/attach functions
		size_type data_capacity; // Total capacity of dynamic array
    };
}
